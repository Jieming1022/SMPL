...
def visualize(
    ...
    if filename and mode == 'analysis':
        cm.to_excel(os.path.join(os.path.dirname(filename), 'cm.xlsx'), index=False)
    elif mode == 'web':
        return cm
    return pp_matrix(cm, output_fname=filename, fz=font_size, figsize=fig_size)
